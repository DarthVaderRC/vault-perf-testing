...
export const options = {
  ...
  scenarios: {
    VaultLogin_AppRole: {
      ...
      startRate: 50, // Start with 10 requests per second
      timeUnit: '1s',
      preAllocatedVUs: 200, 
      maxVUs: 400, 
      stages: [
        { target: 150, duration: '0.5m' }, // Ramp-up to 20 requests per second over 5 minutes
        { target: 300, duration: '1m' }, // Then ramp-up to 60 requests per second over the next 10 minutes
        { target: 300, duration: '1m' }, // Stay at 60 requests per second for 10 minutes
        { target: 150, duration: '0.5m' }, // Ramp-down to 20 requests per second over 5 minutes
